...
let odata = isDevelop ? { username: 'superAdmin', password: 'admin123', code: '' }  : { username: '', password: '', code: '' }
  ...
  <div class="login-container">
    <div class="login-width md:w-10/12 w-11/12 mx-auto flex justify-between h-full items-center">
      <div class="w-6/12 mx-auto left-panel rounded-l pl-5 pr-5 hidden md:block">
        <div class="logo"><img :src="`${$url}logo.svg`" width="120"><span>{{ $title }}</span></div>
      ...
      <div class="md:w-6/12 w-11/12 md:rounded-r mx-auto pl-5 pr-5 pb-10">
        ...
        <a-form :model="form" @submit="handleSubmit">
          ...
          <div class="flex w-3/4 pt-2 mx-auto items-stretch justify-around">
            ...
            <a-avatar class="other-login alipay"><icon-google-circle-fill /></a-avatar>
          </div>
        </a-form>
      </div>
    </div>
...
.login-container {
  ...
  .logo {
    ...
    span {
      font-size: 28px; margin-left: 15px; margin-top: 10px;
